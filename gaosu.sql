...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (1, 1, '超级管理员', '菜单管理', '添加', '192.255.255.255', 'admin/sysmenu/add', 'id:1', '2019-04-26 16:46:32');
...
INSERT INTO `sys_log` VALUES (18, 1, '超管', '配置管理', '新增', '::1', 'admin/sysconfig/add', '', '2019-04-30 11:50:55');
INSERT INTO `sys_log` VALUES (19, 1, '超管', '配置管理', '新增', '::1', 'admin/sysconfig/add', 'config_code:{$param[\'config_code\']},config_name:{$param[\'config_name\']}', '2019-04-30 11:51:32');
INSERT INTO `sys_log` VALUES (20, 1, '超管', '配置管理', '新增', '::1', 'admin/sysconfig/add', '', '2019-04-30 11:53:49');
INSERT INTO `sys_log` VALUES (21, 1, '超管', '配置管理', '新增', '::1', 'admin/sysconfig/add', 'config_code:configTimes,config_name:配置次数', '2019-04-30 11:59:15');
...
INSERT INTO `sys_log` VALUES (26, 1, '超管', '配置管理', '新增', '::1', 'admin/sysconfig/add', '', '2019-04-30 14:49:43');
INSERT INTO `sys_log` VALUES (27, 1, '超管', '配置管理', '新增', '::1', 'admin/sysconfig/add', 'config_code:resertPassword,config_name:重置密码默认', '2019-04-30 14:50:49');
INSERT INTO `sys_log` VALUES (28, 1, '超管', '配置管理', '编辑', '::1', 'admin/sysconfig/edit/id/3', '', '2019-04-30 14:50:54');
INSERT INTO `sys_log` VALUES (29, 1, '超管', '配置管理', '编辑', '::1', 'admin/sysconfig/edit/id/3', '', '2019-04-30 14:51:07');
INSERT INTO `sys_log` VALUES (30, 1, '超管', '配置管理', '编辑', '::1', 'admin/sysconfig/edit', 'id:3', '2019-04-30 14:51:10');
INSERT INTO `sys_log` VALUES (31, 1, '超管', '配置管理', '编辑', '::1', 'admin/sysconfig/edit/id/3', '', '2019-04-30 14:52:10');
INSERT INTO `sys_log` VALUES (32, 1, '超管', '配置管理', '编辑', '::1', 'admin/sysconfig/edit', 'id:3', '2019-04-30 14:53:09');
INSERT INTO `sys_log` VALUES (33, 1, '超管', '配置管理', '删除', '::1', 'admin/sysconfig/del', 'id:2', '2019-04-30 14:55:31');
INSERT INTO `sys_log` VALUES (34, 1, '超管', '配置管理', '删除', '::1', 'admin/sysconfig/del', 'id:1', '2019-04-30 14:55:35');
INSERT INTO `sys_log` VALUES (35, 1, '超管', '用户管理', '重置密码', '::1', 'admin/sysuser/resetPassword', 'id:2', '2019-04-30 14:56:42');
...
INSERT INTO `sys_menu` VALUES (2, 1, 'admin/sysmenu/index', '菜单管理', '<i class=\'layui-icon layui-icon-tabs\'></i>', 'M', '', '', NULL, 0, '', 1100, '', 1);
INSERT INTO `sys_menu` VALUES (4, 0, '', '业务管理', '', 'M', '', '', NULL, 0, '', 2000, '', 1);
INSERT INTO `sys_menu` VALUES (5, 4, '', '测试菜单', '', 'M', '', '', NULL, 0, '', 2100, '', 1);
INSERT INTO `sys_menu` VALUES (6, 2, 'admin/sysmenu/add', '新增', '<i class=\'layui-icon layui-icon-add-circle-fine\'></i>', 'B', '', 'add', 1, 0, '', 1101, '', 1);
...
INSERT INTO `sys_menu` VALUES (18, 2, 'admin/sysmenu/add', '添加下级', '<i class=\'layui-icon layui-icon-add-circle-fine\'></i>', 'B', '#5fb878', 'addDown', 2, 0, '', 1109, '', 1);
INSERT INTO `sys_menu` VALUES (19, 2, 'admin/sysmenu/edit', '编辑', '<i class=\'layui-icon layui-icon-edit\'></i>', 'B', '', 'edit', 2, 0, '', 1108, '', 1);
INSERT INTO `sys_menu` VALUES (20, 2, 'admin/sysmenu/del', '删除', '<i class=\'layui-icon layui-icon-delete\'></i>', 'B', '#FF5722', 'del', 2, 0, '', 1100, '', 1);
...
INSERT INTO `sys_menu` VALUES (27, 1, 'admin/sysuser/index', '用户管理', '<i class=\'layui-icon layui-icon-user\'></i>', 'M', '', '', 1, 0, '', 1400, '', 1);
INSERT INTO `sys_menu` VALUES (28, 27, 'admin/sysuser/del', '删除', '<i class=\'layui-icon layui-icon-delete\'></i>', 'B', '#FF5722', 'del', 2, 1, 'id:{id}', 1401, '', 1);
INSERT INTO `sys_menu` VALUES (29, 27, 'admin/sysuser/add', '新增', '<i class=\'layui-icon layui-icon-add-circle-fine\'></i>', 'B', '', 'add', 1, 0, '', 1402, '', 1);
INSERT INTO `sys_menu` VALUES (30, 27, 'admin/sysuser/edit', '编辑', '<i class=\'layui-icon layui-icon-edit\'></i>', 'B', '', 'edit', 2, 0, 'id:{id}', 1401, '', 1);
INSERT INTO `sys_menu` VALUES (31, 27, 'admin/sysuser/resetPassword', '重置密码', '<i class=\'layui-icon layui-icon-refresh\'></i>', 'B', '#5fb878', 'resetPassword', 2, 1, 'id:{id}', 1409, '默认重置密码后为123456', 1);
