...
{block name="formBody"}
    ...
    <div class="layui-form-item">
        <label class="layui-form-label require-mark">酒品图</label>
        <div class="layui-input-block">
            <div class="img-wrap">
                {if isset($imgList)}
                {foreach $imgList as $item}
                <div class="img-block">
                    <button name="image" type="button" class="layui-btn upload" lay-data="{'url': '{:url('admin/upload/image',['type'=>'winejpt'])}'}">
