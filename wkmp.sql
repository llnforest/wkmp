...
CREATE TABLE `pin_site_shop` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品商家表';
...
CREATE TABLE `pin_user` (
  ...
  `vip_team_num` int(11) DEFAULT '1' COMMENT 'vip团队数',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品用户地址表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品购物车表';
...
CREATE TABLE `pin_user_profit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT '0' COMMENT '用户id',
  `child_id` int(11) DEFAULT NULL COMMENT '来源团推id',
...
CREATE TABLE `pin_user_search` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品个人搜索表';
...
CREATE TABLE `pin_wine` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品信息表';
...
CREATE TABLE `pin_wine_brand` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品品牌表';
...
CREATE TABLE `pin_wine_imgs` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `wine_id` (`wine_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品详情图表';
...
CREATE TABLE `pin_wine_order` (
  ...
  `shop_id` int(11) DEFAULT '0' COMMENT '自提门店id',
...
-- ----------------------------
INSERT INTO `pin_wine_order` VALUES ('2019090112320923', '1', '1', '100', '100', '50', '', '2', '2', '悟空名品合肥店-15909301132-合肥市蜀山区金寨南路118号', '1', '李林-13585788049-安徽省合肥市蜀山区创新大道111号', '0', '', '10', '快点发货', '111', '2019-11-15 16:29:05', '2019-12-18 15:22:18');
...
CREATE TABLE `sys_dict_value` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统字典参数表';
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统行为日志表';
