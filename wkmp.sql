...
-- ----------------------------
INSERT INTO `pin_site_shop` VALUES (1, '/images/shop/20200101\\7c8399efe1860c45e105911e0f861ecb.png', '悟空名品合肥店', '15909301132', '合肥市蜀山区金寨南路118号', 1, '2020-01-01 20:54:32', '2020-01-01 20:54:32');
INSERT INTO `pin_site_shop` VALUES (2, '/images/shop/20200101\\26a4b1940f1741ad06eaefa90923b021.png', '悟空名品蚌埠店', '13585789781', '蚌埠市龙子湖区汇源路11号', 2, '2020-01-01 20:57:20', '2020-01-01 20:57:20');
...
CREATE TABLE `pin_user`  (
  ...
  `vip_team_num` int(11) NULL DEFAULT 1 COMMENT 'vip团队数',
...
INSERT INTO `pin_user_cart` VALUES (5, 1, 6, 30, '2019-12-20 16:08:19', '2019-12-20 16:08:19');
...
-- ----------------------------
INSERT INTO `pin_wine_order` VALUES (2019090112320923, 1, 0, 100, 100, 50, '', 2, 2, '悟空名品合肥店-15909301132-合肥市蜀山区金寨南路118号', 1, '李林-13585788049-安徽省合肥市蜀山区创新大道111号', 0, '', 10, '快点发货', '111', '2019-11-15 16:29:05', '2019-12-18 15:22:18', NULL, NULL, NULL, NULL);
INSERT INTO `pin_wine_order` VALUES (2019090112320924, 1, 0, 100, 100, 50, '', 2, 2, '悟空名品合肥店-15909301132-合肥市蜀山区金寨南路118号', 1, '李林-13585788049-安徽省合肥市蜀山区创新大道111号', 0, '', 10, '快点发货', '111', '2019-11-15 16:29:05', '2020-01-02 15:38:12', NULL, NULL, '0000-00-00 00:00:00', NULL);
INSERT INTO `pin_wine_order` VALUES (2019090112320925, 1, 2, 100, 100, 50, '', 2, 2, '悟空名品合肥店-15909301132-合肥市蜀山区金寨南路118号', 1, '李林-13585788049-安徽省合肥市蜀山区创新大道111号', 0, '', 10, '快点发货', '111', '2019-11-15 16:29:05', '2019-12-18 15:22:18', '2020-01-02 16:29:20', '2020-01-02 16:29:24', NULL, NULL);
INSERT INTO `pin_wine_order` VALUES (2019090112320926, 1, 4, 100, 100, 50, '', 2, 2, '悟空名品合肥店-15909301132-合肥市蜀山区金寨南路118号', 1, '李林-13585788049-安徽省合肥市蜀山区创新大道111号', 0, '', 10, '快点发货', '111', '2019-11-15 16:29:05', '2019-12-18 15:22:18', '2019-12-31 16:29:31', '2020-01-01 16:29:41', NULL, '2020-01-26 16:29:48');
...
CREATE TABLE `pin_wine_order_wines`  (
  ...
  INDEX `user_id`(`user_id`) USING BTREE,
  INDEX `wine_id`(`wine_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '酒品订单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_config` VALUES (7, 'winePerExpressPrice', '酒品计件运费', '2', '元', 0, '', '2019-11-14 21:56:45', '2020-01-01 21:29:09');
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 95 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统行为日志表' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'lil', 'c2af7e249c93cf53930c99fb83edc1dc', '开发者账号', 1, '19156017290', '', '::1', '2020-01-01 20:49:48', NULL, '2020-01-01 20:49:48', NULL);
