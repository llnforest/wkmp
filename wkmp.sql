...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品banner表';
...
CREATE TABLE `pin_site_banner_position` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品banner位置表';
...
CREATE TABLE `pin_user_order_gift` (
  ...
  `status` tinyint(3) DEFAULT '0' COMMENT 'orderStatus 订单状态 0:待支付 1:已支付 2已取消 3已发货 4已完成 ',
...
) ENGINE=InnoDB AUTO_INCREMENT=2019111310 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品礼包订单表';

-- ----------------------------
-- Records of pin_user_order_gift
-- ----------------------------
INSERT INTO `pin_user_order_gift` VALUES ('2019111308120921', '0', '1', '0', '黄伟峰', '15788888881', '999', '2', '', '', '2019-11-14 23:44:40', '2019-11-14 23:41:26');
INSERT INTO `pin_user_order_gift` VALUES ('2019111312130921', '0', '0', '1', '李林', '13585788049', '999', '1', '', '', '2019-11-14 23:40:32', '2019-11-14 23:40:37');
...
CREATE TABLE `pin_wine_order` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `user_id` int(11) DEFAULT '0' COMMENT '用户id',
  `status` tinyint(11) DEFAULT '0' COMMENT 'orderStatus 订单状态 0:待支付 1:已支付 2已取消 3已发货 4已完成 5已取消',
  `total_money` int(11) DEFAULT '0' COMMENT '实付订单总额(包含快递费)',
  `mall_wine_money` int(11) DEFAULT '0' COMMENT '酒品市场价订单总额',
  `total_wine_money` int(11) DEFAULT '0' COMMENT '酒品会员价订单总额',
  `transaction_id` varchar(50) NOT NULL COMMENT '微信支付订单号',
  `express_type` tinyint(11) DEFAULT '1' COMMENT 'expressType 提货方式 1:快递 2:自提',
  `shop_info` varchar(255) DEFAULT '0' COMMENT '自提店家冗余',
  `address_info` varchar(255) NOT NULL COMMENT '下单地址冗余',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品订单表';
...
CREATE TABLE `sys_dict` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统字典表';
...
CREATE TABLE `sys_dict_value` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统字典参数表';
...
INSERT INTO `sys_dict_value` VALUES ('43', '31', '已取消', '2', '#999999', '2', '', '2019-11-14 22:13:11', '2019-11-14 22:13:11');
INSERT INTO `sys_dict_value` VALUES ('44', '31', '已完成', '3', '#009688', '3', '', '2019-11-14 22:13:55', '2019-11-14 22:13:55');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统行为日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='后台菜单表';
...
INSERT INTO `sys_menu` VALUES ('102', '0', 'admin/order/wine', '订单管理', '', 'M', '', '', '0', '0', '', '5000', '', '1');
INSERT INTO `sys_menu` VALUES ('103', '102', 'admin/orderwine/index', '酒品订单', '', 'M', '', '', '1', '0', '', '5100', '', '1');
INSERT INTO `sys_menu` VALUES ('104', '103', 'admin/orderwine/add', '新增', '<i class=\'layui-icon layui-icon-add-circle-fine\'></i>', 'B', '', 'add', '1', '0', '', '5109', '', '1');
INSERT INTO `sys_menu` VALUES ('105', '103', 'admin/orderwine/edit', '编辑', '<i class=\'layui-icon layui-icon-edit\'></i>', 'B', '', 'edit', '2', '0', '', '5102', '', '1');
INSERT INTO `sys_menu` VALUES ('106', '103', 'admin/orderwine/del', '删除', '<i class=\'layui-icon layui-icon-delete\'></i>', 'B', '#FF5722', 'del', '2', '0', '', '5101', '', '1');
...
INSERT INTO `sys_menu` VALUES ('111', '107', 'admin/ordergift/edit', '发货', '', 'B', '#1e9fff', 'setSend', '2', '0', '', '5203', '', '1');
INSERT INTO `sys_menu` VALUES ('112', '107', 'admin/ordergift/edit', '完成', '', 'B', '#009688', 'setSuccess', '2', '0', '', '5204', '', '1');
INSERT INTO `sys_menu` VALUES ('113', '107', 'admin/ordergift/edit', '取消订单', '', 'B', '#999999', 'setCancel', '2', '0', '', '5209', '', '1');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '14e1b600b1fd579f47433b88e8d85291', '超管', '1', '19156017290', '', '::1', '2019-11-14 21:06:14', null, '2019-11-14 21:06:14', null);
