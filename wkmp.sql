...
CREATE TABLE `pin_user`  (
  ...
  `level` tinyint(3) NULL DEFAULT 0 COMMENT 'userLevel 会员等级：0普通会员 1vip会员 2推广顾问 3高级顾问',
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '名品用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pin_user_order_gift`  (
  ...
  `status` tinyint(3) NULL DEFAULT 0 COMMENT 'orderStatus 订单状态 0:待支付 1:已支付  2已发货 3已取消 4已完成 ',
  ...
  `gift_type` tinyint(3) NULL DEFAULT 1 COMMENT 'gitType 礼包品种：1： 2： 3：',
...
CREATE TABLE `pin_user_profit`  (
  ...
  `type` tinyint(3) NULL DEFAULT 1 COMMENT 'profitType 奖励类型：1礼包奖励 2销售额奖励 3流通酒奖励',
...
CREATE TABLE `pin_user_search`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '酒品个人搜索表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pin_user_take`  (
  ...
  `status` tinyint(3) NULL DEFAULT 1 COMMENT 'takeStatus 提现状态：0提交待审核 1提现成功 2审核失败',
  `transaction_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '微信支付订单号',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '备注',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `pin_wine_brand`  (
  ...
  `status` tinyint(3) NULL DEFAULT 1 COMMENT 'status 状态 0:禁用 1:正常',
...
CREATE TABLE `pin_wine_order`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `user_id` int(11) NULL DEFAULT 0 COMMENT '用户id',
  `status` tinyint(11) NULL DEFAULT 0 COMMENT 'orderStatus 订单状态 0:待支付 1:已支付  2已发货 3已取消 4已完成',
  ...
  `transaction_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '微信支付订单号',
  `express_type` tinyint(11) NULL DEFAULT 1 COMMENT 'expressType 提货方式 1:快递 2:自提',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '酒品订单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pin_wine_order_wines`  (
  ...
  INDEX `user_id`(`user_id`) USING BTREE,
  INDEX `wine_id`(`wine_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '酒品订单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_dict` VALUES (33, '配送类型', 'expressType', 0, '', '2019-11-15 14:15:29', '2019-11-15 14:15:29');
...
CREATE TABLE `sys_dict_value`  (
  ...
  `update_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统字典参数表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 73 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统行为日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 131 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台菜单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (4, 0, 'admin/siteinfo/index', '商城管理', '', 'M', '', '', NULL, 0, '', 2000, '', 1);
INSERT INTO `sys_menu` VALUES (5, 4, 'admin/siteinfo/index', '商城管理', '', 'M', '', '', NULL, 0, '', 2100, '', 1);
...
INSERT INTO `sys_menu` VALUES (38, 4, 'admin/siteshop/index', '门店管理', '', 'M', '', '', NULL, 0, '', 2200, '', 1);
INSERT INTO `sys_menu` VALUES (39, 4, 'admin/sitebanner/index', '广告管理', '', 'M', '', '', NULL, 0, '', 2300, '', 1);
...
INSERT INTO `sys_menu` VALUES (53, 4, 'admin/sitesearchhot/index', '热搜管理', '', 'M', '', '', NULL, 0, '', 2400, '', 1);
...
INSERT INTO `sys_menu` VALUES (57, 0, 'admin/wine/index', '酒品管理', '', 'M', '', '', NULL, 0, '', 3000, '', 1);
INSERT INTO `sys_menu` VALUES (58, 57, 'admin/wine/index', '酒品管理', '', 'M', '', '', NULL, 0, '', 3100, '', 1);
INSERT INTO `sys_menu` VALUES (59, 57, 'admin/winebrand/index', '品牌管理', '', 'M', '', '', NULL, 0, '', 3200, '', 1);
...
INSERT INTO `sys_menu` VALUES (65, 58, 'admin/wine/editjpt', '酒品图', '<i class=\'layui-icon layui-icon-edit\'></i>', 'B', '#ffb800', 'edit', 2, 0, 'wine_id:{wine_id}', 3102, '', 1);
...
INSERT INTO `sys_menu` VALUES (67, 0, 'admin/uservip/index', '用户管理', '', 'M', '', '', NULL, 0, '', 4000, '', 1);
INSERT INTO `sys_menu` VALUES (68, 67, 'admin/usercommon/index', '普通用户', '', 'M', '', '', NULL, 0, '', 4200, '', 1);
...
INSERT INTO `sys_menu` VALUES (84, 67, 'admin/usercart/index', '购物车管理', '', 'M', '', '', NULL, 0, '', 4500, '', 1);
...
INSERT INTO `sys_menu` VALUES (88, 67, 'admin/usersearch/index', '搜索管理', '', 'M', '', '', NULL, 0, '', 4600, '', 1);
...
INSERT INTO `sys_menu` VALUES (92, 67, 'admin/uservip/index', '会员管理', '', 'M', '', '', NULL, 0, '', 4100, '', 1);
INSERT INTO `sys_menu` VALUES (93, 72, 'admin/userprofit/index', '收益纪录', '', 'B', '#01aaed', 'showProfit', 2, 0, '', 4113, '', 1);
INSERT INTO `sys_menu` VALUES (94, 72, 'admin/usertake/index', '提现记录', '', 'B', '#01aaed', 'showTake', 2, 0, '', 4114, '', 1);
INSERT INTO `sys_menu` VALUES (95, 72, 'admin/useraddress/index', '收货地址', '', 'B', '#01aaed', 'showAddress', 2, 0, '', 4112, '', 1);
INSERT INTO `sys_menu` VALUES (96, 72, 'admin/uservip/index', '查看下级', '', 'B', '#5fb878', 'showChildren', 2, 0, '', 4119, '', 1);
INSERT INTO `sys_menu` VALUES (97, 67, 'admin/useraddress/index', '收货地址', '', 'M', '', '', 1, 0, '', 4300, '', 1);
...
INSERT INTO `sys_menu` VALUES (101, 68, 'admin/useraddress/index', '收货地址', '', 'B', '#01aaed', 'showAddress', 2, 0, '', 4203, '', 1);
INSERT INTO `sys_menu` VALUES (102, 0, 'admin/order/wine', '订单管理', '', 'M', '', '', NULL, 0, '', 5000, '', 1);
INSERT INTO `sys_menu` VALUES (107, 102, 'admin/ordergift/index', '礼品订单', '', 'M', '', '', 1, 0, '', 5200, '', 1);
...
INSERT INTO `sys_menu` VALUES (111, 107, 'admin/ordergift/setsend', '发货', '', 'B', '#1e9fff', 'setSend', 2, 0, '', 5203, '', 1);
INSERT INTO `sys_menu` VALUES (112, 107, 'admin/ordergift/setsuccess', '完成', '', 'B', '#009688', 'setSuccess', 2, 0, '', 5204, '', 1);
INSERT INTO `sys_menu` VALUES (113, 107, 'admin/ordergift/setcancel', '取消订单', '', 'B', '#999999', 'setCancel', 2, 0, '', 5209, '', 1);
INSERT INTO `sys_menu` VALUES (114, 107, 'admin/ordergift/setpay', '支付', '', 'B', '#5fb878', 'setPay', 2, 0, '', 5202, '', 1);
INSERT INTO `sys_menu` VALUES (120, 102, 'admin/orderwine/index', '酒品订单', '', 'M', '', '', NULL, 0, '', 5100, '', 1);
...
INSERT INTO `sys_menu` VALUES (126, 120, 'admin/orderwine/setPay', '支付', '', 'B', '#5fb878', 'setPay', 2, 0, '', 5102, '', 1);
INSERT INTO `sys_menu` VALUES (127, 120, 'admin/orderwine/setSend', '发货', '', 'B', '#1e9fff', 'setSend', 2, 0, '', 5103, '', 1);
INSERT INTO `sys_menu` VALUES (128, 120, 'admin/orderwine/setSuccess', '完成', '', 'B', '', 'setSuccess', 2, 0, '', 5104, '', 1);
INSERT INTO `sys_menu` VALUES (129, 120, 'admin/orderwine/setCancel', '取消订单', '', 'B', '#999999', 'setCancel', 2, 0, '', 5105, '', 1);
INSERT INTO `sys_menu` VALUES (130, 120, 'admin/orderwine/detail', '订单详情', '', 'B', '', 'show', 2, 0, '', 5108, '', 1);
...
CREATE TABLE `sys_role`  (
  ...
  `status` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT 'status 状态 0:禁用 1:正常',
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (0, '部门经理', 0, '', 1, '2019-04-22 11:19:18', '2019-04-30 15:49:21');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'lil', '1c9c65587af89d4f5cab00b8fa27e0a1', '开发者账号', 1, '19156017290', '', NULL, NULL, NULL, '2019-04-30 14:56:42', NULL);
INSERT INTO `sys_user` VALUES (2, 'admin', '14e1b600b1fd579f47433b88e8d85291', '超级管理员', 1, '19156017290', '', '::1', '2019-11-15 08:55:57', NULL, '2019-11-15 17:18:55', NULL);
