...
CREATE TABLE `pin_user` (
  ...
  `level` tinyint(3) DEFAULT '0' COMMENT '会员等级：0普通会员 1vip会员 2推广顾问 3高级顾问',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品用户表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品用户地址表';
...
CREATE TABLE `pin_user_gift_order` (
  ...
  `status` tinyint(3) DEFAULT '0' COMMENT '订单状态 0:待支付 1:已支付 2已取消',
  `name` varchar(255) DEFAULT NULL COMMENT '会员姓名',
  `phone` int(11) NOT NULL COMMENT '联系方式',
  `type` tinyint(3) DEFAULT '1' COMMENT '礼包品种：1： 2： 3：',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品礼包订单表';

-- ----------------------------
-- Records of pin_user_gift_order
-- ----------------------------
...
CREATE TABLE `pin_user_profit` (
  ...
  `type` tinyint(3) DEFAULT '1' COMMENT '会员等级：1礼包奖励 2销售额奖励 3流通酒奖励',
  `money` int(11) DEFAULT '0' COMMENT '奖励金额',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `from_id` (`from_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品用户奖励表';
...
CREATE TABLE `pin_user_search` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品个人搜索表';
...
CREATE TABLE `pin_user_take` (
  ...
  `status` tinyint(3) DEFAULT '1' COMMENT '提现状态：0提交待审核 1提现成功 2审核失败',
  `transaction_id` varchar(50) NOT NULL COMMENT '微信支付订单号',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='名品用户提现表';
...
CREATE TABLE `pin_wine_brand` (
  ...
  `status` tinyint(3) DEFAULT '1' COMMENT '状态 0:禁用 1:正常',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品购物车表';

-- ----------------------------
-- Records of pin_wine_cart
-- ----------------------------
...
CREATE TABLE `pin_wine_imgs` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `wine_id` (`wine_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='酒品详情图表';
...
CREATE TABLE `pin_wine_order` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `user_id` int(11) DEFAULT '0' COMMENT '用户id',
  `status` tinyint(11) DEFAULT '0' COMMENT '订单状态 0:待支付 1:已支付 2已取消 3已发货 4已完成 5已取消',
  ...
  `transaction_id` varchar(50) NOT NULL COMMENT '微信支付订单号',
  `is_express` tinyint(11) DEFAULT '1' COMMENT '提货方式 1:快递 2:自提',
...
CREATE TABLE `sys_dict` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统字典表';
...
CREATE TABLE `sys_dict_value` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统字典参数表';
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统行为日志表';
...
CREATE TABLE `sys_menu` (
  ...
  `menu_type` varchar(5) NOT NULL COMMENT '菜单类型  M:菜单 B:按钮 G:接口 T:分栏',
  `btn_css` varchar(20) NOT NULL COMMENT '按钮样式',
  `btn_func` varchar(20) NOT NULL COMMENT '按钮方法',
  `btn_type` tinyint(1) DEFAULT NULL COMMENT '按钮类型：1:列表按钮 2:操作按钮',
...
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='后台菜单表';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '14e1b600b1fd579f47433b88e8d85291', '超管', '1', '19156017290', '', '::1', '2019-11-13 23:02:02', null, '2019-11-13 23:02:02', null);
